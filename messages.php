    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            while ($row = mysqli_fetch_assoc($messages)) {
                if ($row["sender"] == $myId) {
                    echo "<main class='msger-chat'><div class='msg right-msg'>
            ...
            if ($row = mysqli_fetch_assoc($messages) < 1) {
                echo "<p id='no-messages' style='text-align: center;'>Select a user to start a conversation.</p>";
            }
            ...
            <?php
            if (mysqli_fetch_assoc($messages) > 0) {
                echo "<form class='msger-inputarea' method='post' action='process-message.php?senderid=" . $_GET["senderid"] . "&receiverid=" . $myId . "'>  <input type='text' name='message-body' class='msger-input' placeholder='Enter your message...'>
