			...
			<div class="bg-white shadow rounded overflow-hidden">
				<div class="px-4 pt-0 pb-4 bg-dark">
					<div class="media align-items-end profile-header">
						<!-- <?php
					// 	$imgselect = "SELECT profile_img FROM profilesCITproject WHERE user_id = '$myId' ";
					// 	$imgR = mysqli_query($conn, $imgselect);
					// 	if (mysqli_num_rows($imgR) > 0) {
					// 		while ($row = mysqli_fetch_assoc($imgR)) {
					// 			$Pic = $row["profile_img"];
							
					// 		echo "<div class='profile mr-3'> '<img src= '$Pic'  alt=' ...' width='130' class='rounded mb-2 img-thumbnail'></div> ";
					// 	}
					// }
						?> -->
				...
				if ($_SESSION['email'] != $_GET['email']) {
					...
					<a href='editprofile.php' class='btn btn-success btn-lg btn-block' id='edit-profile-button'>Edit profile</a>
